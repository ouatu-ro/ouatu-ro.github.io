...
export async function GET(context) {
  ...
  const posts = (await getCollection("labs")).sort((a, b) => {
    return (
  ...
  const rssURL = new URL("labs-rss.xml", siteOrigin).toString();

  return rss({
    title: `${SITE_TITLE} - Labs Updates`,
    description: `Labs updates from ${SITE_TITLE}`,
    site: siteOrigin,
